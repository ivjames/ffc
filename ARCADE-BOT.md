...
`battingcages` — 11 of the 19 games in the server's earning registry. Run `node scripts/arcade-bot.mjs --list` for the current list and, more
...
Still out: air hockey, pinball, water gun and the driving games; milk
