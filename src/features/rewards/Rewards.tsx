...
function BalanceTile({ label, value, icon }: { label: string; value: string; icon: DrawnIcon }) {
  return (
            ...
            {ticketActivity.length === 0 ? (
              ...
              <div className="space-y-1.5">
                {ticketActivity.map((tx) => (
                  ...
                  >
                    <span className="text-fairway-100/80"><Icon name="award.ticket" /> Tickets · {tx.source ?? ''}</span>
