...
all respect `prefers-reduced-motion`): a three-game arcade stage in the
hero (drag-to-putt mini golf, skee-ball with scored rings, a tap-timing
high striker), a live-reshuffling leaderboard mock, an AI-hunt verify loop, a
