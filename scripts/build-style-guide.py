...
screen(id="sum", name="Summary (final scorecard)", route="/golf/play/:clientId/summary",
 ...
 specs=[
  ...
  (4,"Rewards card","Tickets earned this round (loyalty venues)","full-width card, radius 16","per-reward rows (+N 🎟️ / Adding… / Claimed ✓); “Link rewards card” when no card; hidden when none","--accent","the card surface + a ticket glyph"),
  (5,"Sync note","Leaderboard save status","text","saved / saving / offline / retry","(failure emphasis)","a confirmation tick"),
  (6,"Action buttons","Share this round · View leaderboard · Done","full-width","Share prepares an image; Done → Home","--accent (Done)","ghost + primary surfaces + a share glyph"),
 ]),
